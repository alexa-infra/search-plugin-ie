...
#ifndef __SearchPluginIE_i_h__
#define __SearchPluginIE_i_h__
...
EXTERN_C const IID IID_IPlugin;
    ...
    MIDL_INTERFACE("260860E0-09B6-4743-9650-5FB0D928609A")
...
#define IPlugin_Navigate(This,text,escText,disp,vers)	\
    ( (This)->lpVtbl -> Navigate(This,text,escText,disp,vers) ) 
...
#ifndef __SearchPluginIELib_LIBRARY_DEFINED__
#define __SearchPluginIELib_LIBRARY_DEFINED__

/* library SearchPluginIELib */
/* [custom][helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_SearchPluginIELib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("B414B0D0-AA6D-49b3-836E-F0E4BA93F14D")
CompReg;
#endif
...
class DECLSPEC_UUID("110E5031-E03B-49F1-A78D-F570DE0D0252")
Plugin;
#endif
#endif /* __SearchPluginIELib_LIBRARY_DEFINED__ */
